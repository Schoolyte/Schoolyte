      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="menu">
          ...
          <li><a href="#"> Akademik </a>
            <ul class="submenu">
              <li><a href="#">kalender Akademik</a> <hr class="break"></li>
              <li><a href="#">Jadwal Kelas</a> <hr class="break"></li>
              <li><a href="#">Silabus</a> <hr class="break"></li>
              ...
              <li><a href="#">Penilaian pembelajaran</a> <hr class="break"></li>
              <li><a href="#">kalender Akademik</a> <hr class="break"></li>
              <li><a href="#">Informasi Ujian</a>
                  <ul class="submenu2">
                    <li><a href="#">UTS</a> <hr class="break"></li>
                    <li><a href="#">UAS</a> <hr class="break"></li>
                  </ul>
                  <hr class="break">
              </li>
              <li><a href="#">kalender Akademik</a> <hr class="break"></li>
          ...
          <li><a href="#">Peminjaman</a>
              <ul class="submenu">
                ...
                <li><a href="#">Fasilitas</a>
                    <ul class="submenu2">
                      <li><a href="#">Daftar Fasilitas</a> <hr class="break"></li>
          ...
          <li><a href="#">Kegiatan Sekolah</a>
            <ul class="submenu">
              <li><a href="#">OSIS</a> <hr class="break"></li>
          ...
          <img src="assets/icon.svg" alt="Profil" width="35" height="35"/>
              ...
              <ul class="submenu" bg="dark">
                <li><a href="#">Profile Saya</a> <hr class="break" ></li>
