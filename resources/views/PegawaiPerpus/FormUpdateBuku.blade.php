...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('Style/FormTambah.css') }}">
...
<body>
    <div class="main" style="min-height: 30vh;">
    ...
    <div class="container">
        <h1>Edit Buku</h1>
        <form action="/manageBuku/{{ $buku->id }}" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input name="namaBuku" type="text" class="ctrl1 form-control" id="Nama"
                            placeholder="Nama Buku" value="{{ old('namaBuku', $buku->nama_buku) }}" required></input>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="penulis" type="text" class="ctrl2 form-control" id="Nama"
                            placeholder="Penulis" value="{{ old('penulis', $buku->nama_penulis) }}" required></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input name="tahunTerbit" type="number" class="ctrl3 form-control" id="Nama"
                            ...
                            value="{{ old('tahunTerbit', $buku->tahun_terbit) }}"></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input name="kategori" type="text" class="ctrl4 form-control" id="Nama"
                            placeholder="Kategori" value="{{ old('kategori', $buku->kategori_buku) }}" required></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input name="jumlahBuku" type="number" class="ctrl4 form-control" id="Nama"
                            placeholder="Jumlah buku" value="{{ old('jumlahBuku', $buku->jumlah_buku) }}"
                            required></input>
                        <div class="form-text"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea name="rincianBuku" type="text" class="ctrl5 form-control" id="Rincian" placeholder="Rincian Buku"
                            required>{{ old('rincianBuku', $buku->rincian_buku) }}</textarea>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3">
