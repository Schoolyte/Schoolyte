...
<head>
    ...
    <title>Ambil Saldo | Schoolyte</title>
...
<body>
    <div class="view-rapor">
        <div class="page-tittle1">
            <h5 class="tittle1">Ambil Saldo Stand </h5>
            <ul class="breadcrumb">
                <li><a href="#">Pegawai Kantin</a></li>
                <li><a href="">Ambil Saldo Stand</a></li>
            </ul>
        </div>
                ...
                <table class="table table-hover" style="width: 100%; text-align:center">
                    ...
                    @foreach ($stands as $item)
                        <tr>
                            ...
                            <td>{{ $item->saldo }}</td>
                            <td>
                                <a href="{{ route('pkantin.dashboard.ambilsaldo', ['id' => $item->id]) }}" class="btn btn-success" style="background-color:#F24E1A ;border:none">Ambil Saldo</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
