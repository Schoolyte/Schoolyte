    ...
    <div class="view-rapor">
        ...
        <div class="section-card" style="top: 500px; left:250px">
            <div style="position: relative; width: 100%; padding: 3rem;">
                @auth('siswa')
                    <form action="{{ route('Topup.store', ['siswa']) }}" method="POST" class="p-4">
                        @csrf
                        <div class="mb-4 col">
                            <label class="mb-2">Jumlah Top Up</label>
                ...
                @auth('guru')
                    <form action="{{ route('Topup.store', ['guru']) }}" method="POST" class="p-4">
                        @csrf
                        <div class="mb-4 col">
                            <label class="mb-2">Jumlah Top Up</label>
                            <input type="text" name="amount" class="form-control">
