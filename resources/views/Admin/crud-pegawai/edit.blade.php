...
<head>
    ...
    <title>Edit Pegawai | Schoolyte</title>
...
<body>
    <div class="view-rapor">
        <div class="page-tittle1">
            <h5 class="tittle1">Edit Pegawai</h5>
            <ul class="breadcrumb">
        ...
        <div class="section-card" style="top: 500px; left:250px">
            <div style="position: relative; width: 100%; padding: 3rem;">
                <form action="{{ route('admin.dashboard.crud-pegawai.update', [$pegawai->id]) }}" method="POST" class="p-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex gap-4">
                        ...
                        <div class="mb-4 col">
                            ...
                            <input type="text" name="pass" class="form-control" value="{{ $pegawai->pass }}">
                        </div>
                    </div>
                    <div class="d-flex gap-4">
                        <div class="mb-4 col">
                        ...
                        <div class="mb-4 col">
                            ...
                            <input type="text" name="tlpn" class="form-control" value="{{ $pegawai->tlpn }}">
                        </div>
                    </div>
                    <div class="d-flex gap-4">
                        <div class="mb-4 col">
                    ...
                    <div class="d-flex gap-4">
                        <div class="mb-4 col">
                            ...
                            <input type="text" name="tgl_lahir" class="form-control" value="{{ $pegawai->tgl_lahir }}">
                        </div>
                        <div class="mb-4 col">
