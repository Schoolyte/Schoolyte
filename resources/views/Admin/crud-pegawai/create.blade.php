...
<head>
    ...
    <title>Tambah Pegawai | Schoolyte</title>
...
<body>
    <div class="view-rapor">
        <div class="page-tittle1">
            <h5 class="tittle1">Tambah Pegawai</h5>
            <ul class="breadcrumb">
        ...
        <div class="section-card" style="top: 500px; left:250px">
            <div style="position: relative; width: 100%; padding: 3rem;">
                <form action="{{ route('admin.dashboard.crud-pegawai.store') }}" method="POST" class="p-4">
                    @csrf
                    ...
                    <button class="btn btn-success" style="margin-bottom:20px;background-color:#F24E1A ;border:none">Simpan</button>
                </form>
            </div>
        </div>
    </div>
