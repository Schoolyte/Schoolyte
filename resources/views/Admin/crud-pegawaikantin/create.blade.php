...
<head>
    ...
    <title>Tambah Pegawai Kantin | Schoolyte</title>
...
<body>
    <div class="view-rapor">
        <div class="page-tittle1">
            <h5 class="tittle1">Tambah Pegawai Kantin </h5>
            <ul class="breadcrumb">
        ...
        <div class="section-card" style="top: 500px; left:250px">
            <div style="position: relative; width: 100%; padding: 3rem;">
                <form action="{{ route('admin.dashboard.crud-pegawaikantin.store') }}" method="POST" class="p-4">
                    @csrf
