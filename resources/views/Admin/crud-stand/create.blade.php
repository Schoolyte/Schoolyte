...
<head>
    ...
    <title>Tambah Stand | Schoolyte</title>
...
<body>
    <div class="view-rapor">
        <div class="page-tittle1">
            <h5 class="tittle1">Tambah Stand </h5>
            <ul class="breadcrumb">
        ...
        <div class="section-card" style="top: 500px; left:250px">
            <div style="position: relative; width: 100%; padding: 3rem;">
                <form action="{{ route('admin.dashboard.crud-stand.store') }}" method="POST" class="p-4">
                    @csrf
                    <div class="mb-4">
                        <label class="mb-2">Nama Stand</label>
                        <input type="text" name="nama_stand" class="form-control">
                    </div>
                    <div class="mb-4">
                        <label class="mb-2">Jenis Stand</label>
                        <input type="text" name="jenis_stand" class="form-control">
                    </div>
                    <div class="mb-4">
                        <label class="mb-2">Kode Stand</label>
                        <input type="text" name="kode_stand" class="form-control">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="image" class="form-control" value="https://picsum.photos/200/300">
                    </div>
