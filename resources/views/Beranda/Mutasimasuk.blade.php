...
<head>
    ...
    <link rel="stylesheet" href={{ asset('Style/Mutasimasuk.css') }}>
            ...
            <form action="/Beranda/MutasiMasuk/store" method="POST" class="Regisform">
                ...
                <div class="label">
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <input name="NISN_MUTASI" type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="ctrl2 form-control" id="NISN"  placeholder="Masukkan Nomor Induk Siswa Nasional Anda" required maxlength="10"></input>
                        <div class="form-text"></div>
                    </div>
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <input name="EMAIL_MUTASI" class="ctrl8 form-control" id="Email"  placeholder="Masukkan Email Anda" required></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3 col-sm-6">
