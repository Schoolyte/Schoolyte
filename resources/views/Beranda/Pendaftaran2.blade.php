...
<head>
    ...
    <link rel="stylesheet" href={{asset('Style/Pendaftaran2.css')  }}>
</head>
<body>
    <div class="container">
        <div class="regis">
            ...
            <form action="/Beranda/Pendaftaran/store" method="POST" class="Regisform">
                ...
                <div class="label">
                    <div class="nama">
                        ...
                        <input name="NAMA_PENDAFTAR" type="text" class="ctrl1 form-control" id="Nama"  placeholder="Masukkan Nama Lengkap Anda "></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3 col-sm-6">
                        <label for="exampleInputText" class="form2 form-label">Nomor Induk Siswa Nasional (NISN)</label>
                        <input name="NISN_PENDAFTAR" class="ctrl2 form-control" id="NISN"  placeholder="Masukkan Nomor Induk Siswa Nasional Anda"></input>
                        <div class="form-text"></div>
                    </div>
                    <label for="exampleSelect" class="form3 form-label">Jenis Kelamin</label>
                    <select name="JENIS_KELAMIN_PENDAFTAR" class="select form-select" aria-label="Default select example" Id="JK">
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <input name="TEMPAT_LAHIR_PENDAFTAR" class="c1 form-control" id="T4L"  placeholder="Masukkan Tempat Lahir Anda"></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3 col-sm-6">
                        <label for="exampleInputDate" class="form4 form-label">Tanggal Lahir</label>
                        <input name="TANGGAL_LAHIR_PENDAFTAR" type="date" class="ctrl4 form-control" id="TL"  placeholder="Masukkan Tanggal Lahir Anda"></input>
                        <div class="form-date"></div>
                    </div>
                    <div class="mb-3 col-sm-6">
                        <label for="exampleInputText" class="form5 form-label">Nama Orang Tua/Wali</label>
                        <input name="NAMA_ORTU_PENDAFTAR"class="ctrl5 form-control" id="NamaOrtu"  placeholder="Masukkan Nama Orang Tua/Wali Anda"></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3 col-sm-6">
                        <label for="exampleInputText" class="form6 form-label">Alamat Lengkap</label>
                        <input name="ALAMAT_LENGKAP_PENDAFTAR" class="ctrl6 form-control" id="Alamat"  placeholder="Masukkan Alamat Lengkap Anda"></input>
                        <div class="form-text"></div>
                    </div>

                    <div class="mb-3 col-sm-6">
                        <label for="exampleInputText" class="form9 form-label">Agama</label>
                        <input name="AGAMA_PENDAFTAR" class="ctrl9 form-control" id="Agama"  placeholder="Masukkan Agama Anda"></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="email mb-3 ">
                        <label for="exampleInputText" class="form11 form-label">Email</label>
                        <input name="EMAIL_PENDAFTAR" type="email" class="ctrl11 form-control" id="Email"  placeholder="Masukkan Email Anda "></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="suket mb-3 ">
                        <label for="exampleInputText" class="form12 form-label">Ijazah SMP</label>
                        <input name="IJAZAH_SMP_PENDAFTAR" type="file" class="ctrl12 form-control" id="Ijazah" accept="application/pdf"  placeholder=" "></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="suket mb-3 ">
                        <label for="exampleInputText" class="form13 form-label">Akte Kelahiran</label>
                        <input name="AKTE_PENDAFTAR"type="file" class="ctrl13 form-control" id="Akte" accept="application/pdf"  placeholder=" "></input>
                        <div class="form-text"></div>
                    </div>
                    <div class="suket mb-3 ">
                        <label for="exampleInputText" class="form14 form-label">Kartu Keluarga (KK)</label>
                        <input name="KK_PENDAFTAR" type="file" class="ctrl14 form-control" id="KK" accept="application/pdf"  placeholder=" "></input>
                        <div class="form-text"></div>
                    </div>
